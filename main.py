...
class Dot:
    ...
    def __init__(self, pos) -> None:
        ...
        Raises:
            ValueError: если входные данные не соответсвуют требуемому мыформату
        """
    ...
    def __set_pos_from_str(self, pos: str) -> None:
        """задание координат из строки А1, В4 ...
...
class Board:
    ...
    def __check_for_winner(self) -> bool:
        ...
        """
        # если у игрока не остальсь кораблей, рисуем доску и выходим
